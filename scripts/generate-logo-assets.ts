...
const variants: Variant[] = [
  ...
  // Kotlin/Wasm PWA shell (apps/web/pwa/** is staged to the root of the served tree). Same five
  // files as the Vue app above; both targets stay until the Vue PWA is retired in plan 5.
