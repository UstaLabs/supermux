...
export function isCoreBacked(adapter: AgentAdapter): boolean {
  return adapter instanceof CoreCodexAdapter || adapter instanceof CoreGrokAdapter || adapter instanceof CoreOpenCodeAdapter || adapter instanceof CoreCursorAdapter
}
