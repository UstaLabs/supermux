...
/** Null-object default — used by [NotificationController]'s and [dev.supermux.desktop.shell.AppShell]'s
 *  parameter defaults so call sites/tests that don't care about notifications (e.g. the existing
 *  `AppShellTest` suite) keep compiling with zero changes. Production always passes a real
