...
package dev.supermux.ui.notify
...
/**
 * Plain (non-`@Composable`) class exactly like [dev.supermux.ui.shell.ShellUiState] —
...
class NotificationController(
     ...
     * [muted] is the CALLER's job (`SupermuxApp` already has the sessions flow / `ui.selectedId` /
