...
/**
 * Bare http(s) URLs in assistant prose render as clickable links. We can't observe a click opening
 * a browser under Xvfb, so this asserts the load-bearing fact directly — the rendered
